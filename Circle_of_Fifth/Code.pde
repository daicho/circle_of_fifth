...
public Code[] codes = {
  ...
  new Code("Ebm7", 6, new int[]{6, 9, 1, 4}),
  ...
  new Code("EbmM7", 6, new int[]{6, 9, 1, 5}),
...
public class CodePlayer {
  ...
  public void play(Code code, int center) {
    ...
    for (int i = 0; i < voiced_notes.length; i++) {
      notes[i] = new Note(BASE_NOTE * pow(2, voiced_notes[i] / float(OCTAVE)), volume, fade_time, out);
      notes[i].play();
    }
  }
